  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
        <SectionTitle label="Bảng giá" title="Chọn chất riêng" />
        <div className="grid gap-px bg-border md:grid-cols-2">
          {services.map((s) => (
            <article
              key={s.id}
              className="grid grid-cols-[120px_1fr] bg-background md:grid-cols-[180px_1fr]"
            >
      ...
      <section className="bg-primary px-5 py-16 text-primary-foreground">
        <div className="mx-auto max-w-7xl md:flex md:items-end md:justify-between">
          <SectionTitle
            label="Quy trình"
          ...
          <Button asChild variant="secondary" size="lg">
            <Link href="/contact">Liên hệ tiệm</Link>
          </Button>
        </div>
      </section>
    </>
