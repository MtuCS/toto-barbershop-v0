        ...
        <section className="pb-12 pt-6 md:pb-20 md:pt-10">
          <div className="mx-auto max-w-[1400px] px-5 md:px-8">
            <div className="w-full">
              ...
              <h2 id="home-our-shop-title" className="home-section-title mt-2 text-center font-sans text-[clamp(2.5rem,5vw,4.25rem)] font-bold leading-[1.05] tracking-[-0.04em] text-[#f2f5f3]">
                Không gian tiệm
              </h2>
            </div>
          </div>
