...
export function PageHero({
  ...
  return (
    <section className="relative min-h-[52vh] overflow-hidden bg-neutral-950 text-white">
      {image && (
        <Image
          src={image}
          alt=""
      ...
      <div className="relative mx-auto flex min-h-[52vh] max-w-7xl flex-col justify-end px-5 py-14 md:px-8 md:py-20">
        <p className="mb-4 text-xs font-semibold uppercase tracking-[.28em] text-emerald-200">
          {eyebrow}
        </p>
        <h1 className="max-w-5xl font-display text-5xl font-bold uppercase leading-[.9] md:text-8xl">
          {title}
        </h1>
...
export function SectionTitle({
  ...
  return (
    <div className="mb-10 max-w-3xl">
      <p
        className={`mb-3 text-xs font-bold uppercase tracking-[.25em] ${labelClassName}`}
      >
        {label}
      </p>
