"use client"
import Link from "next/link"; import { usePathname, useRouter } from "next/navigation"; import { LayoutDashboard, Package, Tags, Scissors, GraduationCap, BookOpen, Images, ShoppingBag, Users, ImageIcon, Settings, LogOut, Menu } from "lucide-react"; import { useState, useEffect } from "react"; import { useAuthStore } from "@/store/auth-store"
const nav=[['dashboard','Tổng quan',LayoutDashboard],['products','Sản phẩm',Package],['categories','Danh mục',Tags],['services','Dịch vụ',Scissors],['training','Đào tạo',GraduationCap],['merchandise-stories','Stories',BookOpen],['lookbook','Lookbook',Images],['orders','Đơn hàng',ShoppingBag],['customers','Khách hàng',Users],['media','Media',ImageIcon],['settings','Cài đặt',Settings]] as const
